...
class TestInterviewQuestions:
    ...
    def test_populated_questions(self):
        ...
        questions = InterviewQuestions(
            questions_for_employer=["What is the team structure?", "What technologies do you use?"],
            anticipated_questions=["Tell me about yourself", "Why do you want this job?"],
            suggested_answers=["I am a software engineer with 5 years experience...", "I am excited about this opportunity because..."]
        )
...
class TestNextSteps:
    ...
    def test_populated_next_steps(self):
        ...
        steps = NextSteps(
            ...
            long_term_development=["Learn new technologies", "Build portfolio projects"],
            application_strategy=["Apply to similar positions", "Network with industry professionals"],
...
class TestAnalysisResult:
    ...
    def test_complete_analysis_result(self):
        ...
        improvements = ResumeImprovements(
            keyword_suggestions=["Python", "JavaScript"]
        )
        ...
        steps = NextSteps(
            immediate_actions=["Update resume"]
        )
