...
from src.error_handler import (
    ErrorHandler, retry_on_failure, retry_on_failure_async,
    default_error_handler
)
from src.models import ErrorInfo, ConfidenceLevel
...
class TestErrorHandler:
    ...
    def test_handle_llm_error_rate_limit(self):
        ...
        assert error_info.user_message == "API rate limit exceeded. Please try again later."
    ...
    def test_handle_llm_error_timeout(self):
        ...
        assert error_info.user_message == "Request timed out. Please check your connection and try again."
    ...
    def test_handle_llm_error_authentication(self):
        ...
        assert error_info.user_message == "Authentication failed. Please check your API key."
    ...
    def test_handle_llm_error_quota(self):
        ...
        assert error_info.user_message == "API quota exceeded. Please check your billing status."
        assert error_info.confidence == ConfidenceLevel.HIGH
    ...
    def test_handle_llm_error_network(self):
        ...
        assert error_info.user_message == "Network error occurred. Please check your internet connection."
        assert error_info.confidence == ConfidenceLevel.MEDIUM
    ...
    def test_handle_llm_error_unknown(self):
        ...
        assert error_info.user_message == "An unexpected error occurred: Some random error"
        assert error_info.confidence == ConfidenceLevel.LOW
...
class TestErrorHandlerIntegration:
    ...
    def test_backoff_calculation(self):
        ...
        handler = ErrorHandler(retry_delay=1.0, backoff_factor=2.0, max_delay=10.0)
