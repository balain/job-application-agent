...
class JobApplicationMCPServer:
    ...
    async def _get_resume_improvements(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        if results.get('materials'):
            ...
            return [TextContent(type="text", text="No resume improvements generated - application not recommended")]
    
    async def _generate_cover_letter(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        if results.get('materials'):
            ...
            return [TextContent(type="text", text="No cover letter generated - application not recommended")]
    
    async def _prepare_interview_questions(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        if results.get('materials'):
            materials = results['materials']
            output = []
            output.append(f"**QUESTIONS TO ASK THE HIRING MANAGER:**\n{materials.questions_for_employer}\n")
            output.append(f"**ANTICIPATED INTERVIEW QUESTIONS:**\n{materials.anticipated_questions}\n")
            output.append(f"**SUGGESTED ANSWERS:**\n{materials.suggested_answers}")
            return [TextContent(type="text", text="\n".join(output))]
        else:
            return [TextContent(type="text", text="No interview questions prepared - application not recommended")]
    ...
    async def _get_next_steps(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        if results.get('materials'):
            ...
            return [TextContent(type="text", text="No next steps generated - application not recommended")]
